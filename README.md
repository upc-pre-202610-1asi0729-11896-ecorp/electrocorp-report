...
<table align="center" border="1" width="100%" style="text-align:center; border-collapse: collapse;">
  ...
  <tr><td>TS-09 / US-17 / US-18 / US-29 / US-30 / US-34</td><td>Notifications, recomendaciones y preferencias</td><td>T44</td><td>Alertas desde reglas y eventos</td><td>Conectar alertas, recomendaciones, resumen mensual y preferencias de notificacion mediante reglas, eventos y comandos de Notifications.</td><td>6</td><td>Diego Cabrejos</td><td>Done</td></tr>
  <tr><td>TS-10 / TS-14 / US-15 / US-16 / US-25 / US-35 / US-36 / US-37</td><td>Energy Monitoring y Reporting</td><td>T45</td><td>Lecturas, historial, reportes y exportacion</td><td>Reforzar el flujo de telemetria energetica, consumo actual, historial por fechas, reportes por area/equipo, metas y exportacion de datos.</td><td>6</td><td>Diego Cabrejos / Jean Loa</td><td>Done</td></tr>
  <tr><td>TS-11 / US-08 / US-10 / US-11 / US-12 / US-13 / US-14 / US-23 / US-24 / US-38</td><td>Device Control y automatizacion</td><td>T46</td><td>Dispositivos, grupos, rutinas y modos</td><td>Completar la trazabilidad de emparejamiento, nombres, estados, control remoto, horarios, rutinas, automatizacion comercial y agrupacion de dispositivos.</td><td>6</td><td>Sebastian Tavara / Jairo Santiago</td><td>Done</td></tr>
  <tr><td>TS-12 / TS-16 / US-20 / US-21 / US-26 / US-31 / US-32 / US-33 / US-39 / US-40</td><td>IAM, acceso, perfil y preferencias UI</td><td>T47</td><td>Guards, cuenta, recuperacion y configuracion</td><td>Reforzar autenticacion, proteccion de rutas, recuperacion de contrasena, edicion de perfil, desactivacion de cuenta, tema/idioma y preparacion de permisos para multiples locales o personal.</td><td>6</td><td>Jairo Santiago / Timothy Documet</td><td>Done</td></tr>
  <tr><td>TS-17 / US-09 / US-40</td><td>Workplace y geocoding por capas</td><td>T48</td><td>Sedes, ubicaciones y guia inicial</td><td>Mover geocoding hacia application/infrastructure, reforzar gestion de sedes y dejar el flujo preparado para multiples locales y guia inicial de configuracion.</td><td>6</td><td>Sebastian Tavara</td><td>Done</td></tr>
